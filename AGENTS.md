...
- `website/assets/main.js` coordinates scroll, countdown, flight and replay. `website/assets/breath.js` handles opt-in, local-only microphone analysis and track cleanup.
